  ...
  return (
    <section id="about" className='mb-16'>
      ...
      <p className="text-accent">
        ...
        provide real value to <span className="text-primary">users</span>.<br />{" "}
        My problem-solving skills and meticulous attention to detail have
      ...
      <div className="flex mt-10 uppercase items-center lg:text-2xl md:text-4xl text-xl">
        <a href="#resume" className="flex text-center items-center">
          <lord-icon
            target="div"
